...
Run the [DiceBear](https://www.dicebear.com/) avatar service on your own infrastructure. One container turns a seed string into an avatar in 50 styles and five image formats, with no database and no calls to anyone else's servers.
...
- 50 avatar styles by various artists; try them all in the [playground](https://www.dicebear.com/playground/)
